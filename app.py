...
# ─── INITIALIZATION ───────────────────────────────────────────────────────────────────────────────────
app = Flask(__name__)
# OpenAI-compatible API endpoint (LM Studio)
LLM_URL = "http://192.168.12.216:1234/v1"
LLM_MODEL = "local-model"  # Change this to match your model name in LM Studio
...
llm = LLMService(url=LLM_URL, model=LLM_MODEL)
audio = AudioService()
